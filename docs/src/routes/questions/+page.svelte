...
<svelte:head>
	<title>Question History — consult-user-mcp</title>
...
<main>
	...
	<section class="questions-section">
		<h1>Real Questions</h1>
		<p class="lead">Examples from real development sessions: choices, blockers, and checkpoint decisions.</p>
		<QuestionHistory />
	</section>
